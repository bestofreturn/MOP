				...
				<div class="row">
					<div class="booking-form">
						...
						<form action="insertReservation.do" method="post">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<span class="form-label">예약 날짜</span> <input
											class="form-control" type="date" name="rDate" required>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<span class="form-label">예약 시간</span> <input
											class="form-control" type="time" name="rDate" required>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<span class="form-label">예약자 이름</span> <input
											class="form-control" type="text"
											value="${loginMember.memberName }" name="rMemberId" readonly>
								...
								<div class="col-md-6">
									<div class="form-group">
										<span class="form-label">인원수</span> <select
											class="form-control" id="headCount" name="rPeople"
							...
							<div class="form-group">
								<span class="form-label">예약자 전화번호</span> <input
									class="form-control" name="rPhone" type="text"> <span
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<span class="form-label">총 합계</span> <input
											class="form-control" name="rPrice" value="${place.price }"
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<fmt:parseNumber var="point" integerOnly="true"
											value="${place.price * 0.01}" />
