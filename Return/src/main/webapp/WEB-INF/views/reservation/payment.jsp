...
<input type="hidden" name="rPhone" value="${reservation.rPhone }">
...
<input type="hidden" name="memberId" value="${loginMember.memberId }">
    ...
    $(function(){
        ...
        IMP.init("imp97586633"); // 'iamport' 대신 부여받은 "가맹점 식별코드"를 사용
        var msg;
        ...
        IMP.request_pay({
            ...
            name : '${loginMember.memberName}님 Mop 예약 결제입니다',
            amount : ${reservation.rPrice},
            buyer_email : "${loginMember.email}",
            buyer_name : "${loginMember.memberId}",
            buyer_tel : "${loginMember.phone}",
            buyer_addr : "${loginMember.addr}",
            ...
            if ( rsp.success ) {
                ...
                //성공시 이동할 페이지
                jQuery("#insert").submit();
            } else {
                msg = '결제에 실패하였습니다.';
                msg += '에러내용 : ' + rsp.error_msg;
                //실패시 이동할 페이지
                location.href="common/errorPage";
                alert(msg);
            }
        });
