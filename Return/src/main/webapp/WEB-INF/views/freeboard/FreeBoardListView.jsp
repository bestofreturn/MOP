		...
		<div class="col-md-12 d-md-block b-2">
			...
			<div class="text-center btn-form">
				<form action="submit" method="POST" class="form-inline">
				    <input type="radio" id="customRadioInline1" name="fTitle" class="custom-control-input" checked>
				    <label class="custom-control-label" for="customRadioInline1">제목</label>
				    <input type="radio" id="customRadioInline2" name="fContent" class="custom-control-input" value='c'>
				...
				<button type="button" class="btn btn-secondary btn-sm" id="listBtn" onclick="location.href = 'freeBoardList.do';">목록</button>
				<button type="button" class="btn btn-secondary btn-sm" id="writeBtn" onclick="location.href = 'freeBoardWriteView.do';">쓰기</button>
			</div>
						...
						<nav aria-label="Page navigation example" class="text-center">
						  	<ul class="pagination">
						  		<c:if test="${pi.currentPage > 1 }">
									<c:url var="first" value="freeBoardList.do">
