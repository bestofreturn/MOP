				...
				<div class="w3-half" id="move"
					...
					<ul
						...
						<li class="w3-dark-grey w3-xlarge w3-padding-32">${loginMember.memberId }님
							환영합니다<a href="home.do" style="color:black;"><i class="fa fa-home fa-lg" aria-hidden="true"></i></a></li>
						<c:set var="List" value="${requestScope['json'].List}" />

						<c:forEach items="${sList }" var="scheduler" varStatus="status">

							<li class="w3-padding-16"><c:out
									value="${scheduler.title }" /></li>
