...
public class Pagination {
	...
	public static FreeBoardPageInfo getFreeBoardPageInfo(int currentPage, int listCount) {
		//즉 pagination 클래스에서 만드는 페이징 처리에 대한 정보를
		//PageInfo 클래스가 저장을 하는 것임
		FreeBoardPageInfo pi = null;
		...
		pi = new FreeBoardPageInfo(currentPage, boardLimit, pageLimit, startPage , endPage, listCount, maxPage);
		return pi;
	}
}
