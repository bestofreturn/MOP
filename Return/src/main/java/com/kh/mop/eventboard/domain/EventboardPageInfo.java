...
public class EventboardPageInfo {
	...
	public EventboardPageInfo() {}

	public EventboardPageInfo(int currentPage, int boardLimit, int pageLimit, int startPage, int endPage, int listCount,
			int maxPage) {
		super();
	...
	public String toString() {
		return "EventboardPageInfo [currentPage=" + currentPage + ", boardLimit=" + boardLimit + ", pageLimit="
